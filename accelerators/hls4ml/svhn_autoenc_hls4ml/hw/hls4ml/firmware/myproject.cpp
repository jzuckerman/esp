...
void myproject(
    ...
    nnet::dense_large<input_t, layer4_t, config4>(input_1, layer4_out, w4, b4);
    ...
    nnet::relu<layer6_t, result_t, relu_config7>(layer6_out, layer9_out);

    // layer8_t layer8_out[N_LAYER_8];
    // #pragma HLS ARRAY_PARTITION variable=layer9_out complete dim=0
    // nnet::dense_large<layer7_t, layer8_t, config8>(layer7_out, layer9_out, w8, b8);
