...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<model_default_t, 262144>(w2, "w2.txt");
        nnet::load_weights_from_txt<model_default_t, 256>(b2, "b2.txt");
        nnet::load_weights_from_txt<model_default_t, 32768>(w4, "w4.txt");
        ...
        nnet::load_weights_from_txt<model_default_t, 1024>(b8, "b8.txt");
        loaded_weights = true;
    }
#endif
